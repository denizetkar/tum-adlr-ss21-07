...
import numpy as np
import torch as th
from models import RnnExtractor, CnnExtractor, EfficientNetExtractor
...
class ActorCriticRnnPolicy(BasePolicy):
    """
    ...
    def _build_rnn_extractor(self) -> None:
        """
        ...
        self.rnn_extractor = RnnExtractor(
    ...
    def _build(self, lr_schedule: Schedule) -> None:
        ...
        """
        self._build_rnn_extractor()

        latent_dim_pi = self.rnn_extractor.latent_dim_pi
        ...
        self.value_net = nn.Linear(self.rnn_extractor.latent_dim_vf, 1)
